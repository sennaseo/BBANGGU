      ...
      <div className="flex-1 px-5">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              <img
                src="/icons/payment/naverpay.png"
                alt="네이버페이"
                className="h-5"
              />
            </button>
            ...
            >
              <img
                src="/icons/payment/kakaopay.png"
                alt="카카오페이"
                className="h-10"
              />
            </button>
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center">
            ...
            <label
              htmlFor="agreement"
              className="ml-2 flex-1 text-left text-sm text-gray-600 flex items-center"
            >
